...
class BilletsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tags' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-10-06 08:24:10',
            'modified' => '2017-10-06 08:24:10'
        ],
    ];
}
